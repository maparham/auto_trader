...
class SweepJobManager:
            ...
            try:
                ...
                while pending:
                    ...
                    if job.cancelled:
                        ...
                        self._reap(procs, futures, seen, job, row_lock, t0, grace)
                        break
    ...
    def _reap(self, procs: list, futures: list, seen: set, job: SweepJob,
        ...
        the main loop, so we do not double-count them. `procs` is the worker
